    ...
    if len(message.text) > 2:    
        ...
        if len(btn) > 10: 
            ...
            await message.reply_text(
                f"<b>Hai 👋 {message.from_user.mention}😍 📁 Found ✨  Files For Your Query : {message.text}👇 </b>",
    ...
    if query.message.reply_to_message.from_user.id == query.from_user.id:
        ...
        if query.data.startswith("next"):
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("📍 JOIN OUR CHANNEL📍", url="https://t.me/DCENIMAS")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                [InlineKeyboardButton("BACK", callback_data="start_data"),
                    InlineKeyboardButton("📡ABOUT📡", callback_data="about_data")],
                [InlineKeyboardButton("✨ SUPPORT ✨", url="https://t.me/Dcenimaunverse")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("SOURCE CODE", url="https://t.me/+3rMfCvw-oJViNzM1")]
            ])
